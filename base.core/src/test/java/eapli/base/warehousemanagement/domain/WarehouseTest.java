...
class WarehouseTest {
    ...
    void testPlantGeneration() {
        ...
        WarehouseBuilder warehouseBuilder = new WarehouseBuilder()
                .addAgvDock("D1", new Location(5, 4), new Location(5, 5), new Location(6, 6), Accessibility.LENGHT_PLUS)
                .addAgvDock("D2", new Location(10, 4), new Location(10, 5), new Location(10, 6), Accessibility.WIDTH_MINUS)
